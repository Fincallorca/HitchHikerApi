...
/**
 * This class stands for TicketResponseData StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:TicketResponseData
 * @subpackage Structs
 */
class TicketResponseData extends AbstractStructBase
{
    /**
     * The ModuleInfo
     * Meta informations extracted from the WSDL
    ...
    public $Source;
    /**
     * The TicketInformation
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * - nillable: true
     * @var \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\ArrayType\ArrayOfTicketResponseInformation
     */
    public $TicketInformation;
    /**
     * Constructor method for TicketResponseData
     * @uses TicketResponseData::setModuleInfo()
     * @uses TicketResponseData::setResponseInfo()
     * @uses TicketResponseData::setSource()
     * @uses TicketResponseData::setTicketInformation()
     ...
     * @param string $source
     * @param \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\ArrayType\ArrayOfTicketResponseInformation $ticketInformation
     */
    public function __construct(\Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\ModuleResponseData $moduleInfo = null, \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\ResponseInfoDetails $responseInfo = null, $source = null, \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\ArrayType\ArrayOfTicketResponseInformation $ticketInformation = null)
    {
        $this
     ...
     * @param \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\ModuleResponseData $moduleInfo
     * @return \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\TicketResponseData
     */
    ...
    /**
     * Get TicketInformation value
     * An additional test has been added (isset) before returning the property value as
     * this property may have been unset before, due to the fact that this property is
     * removable from the request (nillable=true+minOccurs=0)
     * @return \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\ArrayType\ArrayOfTicketResponseInformation|null
     */
    public function getTicketInformation()
    {
        return isset($this->TicketInformation) ? $this->TicketInformation : null;
    }
    /**
     * Set TicketInformation value
     * This property is removable from request (nillable=true+minOccurs=0), therefore
     * if the value assigned to this property is null, it is removed from this object
     * @param \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\ArrayType\ArrayOfTicketResponseInformation $ticketInformation
     * @return \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\TicketResponseData
     */
    public function setTicketInformation(\Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\ArrayType\ArrayOfTicketResponseInformation $ticketInformation = null)
    {
        if (is_null($ticketInformation) || (is_array($ticketInformation) && empty($ticketInformation))) {
            unset($this->TicketInformation);
        } else {
