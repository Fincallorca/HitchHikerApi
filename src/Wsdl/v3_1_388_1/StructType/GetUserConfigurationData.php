...
/**
 * This class stands for GetUserConfigurationData StructType
 * @subpackage Structs
 */
class GetUserConfigurationData extends AbstractStructBase
{
    /**
     * The Login
    ...
    public $Login;
    /**
     * Constructor method for GetUserConfigurationData
     * @uses GetUserConfigurationData::setLogin()
     ...
     * @param \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\LoginData $login
     * @return \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\GetUserConfigurationData
     */
