...
/**
 * This class stands for ReissueResponseData StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:ReissueResponseData
 * @subpackage Structs
 */
class ReissueResponseData extends AbstractStructBase
{
    /**
     * The ModuleInfo
     * Meta informations extracted from the WSDL
     ...
     * - minOccurs: 0
     * - nillable: true
     * @var \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\ReissueResponseTicketNumber
     */
    public $TicketNumber;
    /**
     * Constructor method for ReissueResponseData
     * @uses ReissueResponseData::setModuleInfo()
     * @uses ReissueResponseData::setResponseInfo()
     * @uses ReissueResponseData::setSource()
     * @uses ReissueResponseData::setTicketNumber()
     ...
     * @param \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\ModuleResponseData $moduleInfo
     * @return \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\ReissueResponseData
     */
     ...
     * this property may have been unset before, due to the fact that this property is
     * removable from the request (nillable=true+minOccurs=0)
     * @return \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\ReissueResponseTicketNumber|null
     */
     ...
     * @return \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\ReissueResponseData
     */
    public function setTicketNumber(\Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\ReissueResponseTicketNumber $ticketNumber = null)
    {
