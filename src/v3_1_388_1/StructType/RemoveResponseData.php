...
/**
 * This class stands for RemoveResponseData StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:RemoveResponseData
 * @subpackage Structs
 */
class RemoveResponseData extends AbstractStructBase
{
    /**
     * The ModuleInfo
     * Meta informations extracted from the WSDL
     ...
     * - minOccurs: 0
     * - nillable: true
     * @var \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\ArrayType\ArrayOfRemoveResponsePNRData
     */
    public $PNRs;
    /**
     * The ResponseInfo
    ...
    public $Source;
    /**
     * Constructor method for RemoveResponseData
     * @uses RemoveResponseData::setModuleInfo()
     * @uses RemoveResponseData::setPNRs()
     * @uses RemoveResponseData::setResponseInfo()
     * @uses RemoveResponseData::setSource()
     * @param \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\ModuleResponseData $moduleInfo
     * @param \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\ArrayType\ArrayOfRemoveResponsePNRData $pNRs
     * @param \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\ResponseInfoDetails $responseInfo
     * @param string $source
     */
    public function __construct(\Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\ModuleResponseData $moduleInfo = null, \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\ArrayType\ArrayOfRemoveResponsePNRData $pNRs = null, \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\ResponseInfoDetails $responseInfo = null, $source = null)
    {
        $this
     ...
     * @param \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\ModuleResponseData $moduleInfo
     * @return \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\RemoveResponseData
     */
     ...
     * this property may have been unset before, due to the fact that this property is
     * removable from the request (nillable=true+minOccurs=0)
     * @return \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\ArrayType\ArrayOfRemoveResponsePNRData|null
     */
     ...
     * @return \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\RemoveResponseData
     */
    public function setPNRs(\Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\ArrayType\ArrayOfRemoveResponsePNRData $pNRs = null)
    {
