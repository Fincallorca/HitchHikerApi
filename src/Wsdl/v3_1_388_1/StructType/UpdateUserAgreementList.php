...
/**
 * This class stands for UpdateUserAgreementList StructType
 * @subpackage Structs
 */
class UpdateUserAgreementList extends AbstractStructBase
{
    /**
     * The Login
    ...
    public $Login;
    /**
     * Constructor method for UpdateUserAgreementList
     * @uses UpdateUserAgreementList::setLogin()
     ...
     * @param \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\LoginData $login
     * @return \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\UpdateUserAgreementList
     */
