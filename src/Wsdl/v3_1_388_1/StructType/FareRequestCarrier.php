...
/**
 * This class stands for FareRequestCarrier StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:FareRequestCarrier
 * @subpackage Structs
 */
class FareRequestCarrier extends AbstractStructBase
{
    /**
     * The Code
     * Meta informations extracted from the WSDL
    ...
    public $FareType;
    /**
     * Constructor method for FareRequestCarrier
     * @uses FareRequestCarrier::setCode()
     * @uses FareRequestCarrier::setExclude()
     * @uses FareRequestCarrier::setFareType()
     * @param string $code
     * @param bool $exclude
     ...
     * Set Code value
     * @param string $code
     * @return \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\FareRequestCarrier
     */
