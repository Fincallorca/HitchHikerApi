...
/**
 * This class stands for XtremePricer StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:XtremePricer
 * @subpackage Structs
 */
class XtremePricer extends AbstractStructBase
{
    /**
    ...
    public $XPSearchMode;
    /**
     * Constructor method for XtremePricer
     * @uses XtremePricer::setXPConcurrentAvails()
     * @uses XtremePricer::setXPMaxConnections()
     * @uses XtremePricer::setXPMaxMoveDowns()
     * @uses XtremePricer::setXPSearchMode()
     * @param int $xPConcurrentAvails
     * @param int $xPMaxConnections
     * @param int $xPMaxMoveDowns
     * @param string $xPSearchMode
     */
    public function __construct($xPConcurrentAvails = null, $xPMaxConnections = null, $xPMaxMoveDowns = null, $xPSearchMode = null)
    {
        $this
     ...
     * @param int $xPConcurrentAvails
     * @return \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\XtremePricer
     */
