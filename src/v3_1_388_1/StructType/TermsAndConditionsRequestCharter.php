...
/**
 * This class stands for TermsAndConditionsRequestCharter StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:TermsAndConditionsRequestCharter
 * @subpackage Structs
 */
class TermsAndConditionsRequestCharter extends AbstractStructBase
{
    /**
     * The Account
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for TermsAndConditionsRequestCharter
     * @uses TermsAndConditionsRequestCharter::setAccount()
     * @uses TermsAndConditionsRequestCharter::setTouroperatorCode()
     ...
     * Set Account value
     * @param \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\CharterAccount $account
     * @return \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\TermsAndConditionsRequestCharter
     */
