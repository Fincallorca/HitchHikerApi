...
/**
 * This class stands for RequestLegData StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:RequestLegData
 * @subpackage Structs
 */
class RequestLegData extends AbstractStructBase
{
    /**
     * The ArrivalDate
     * Meta informations extracted from the WSDL
     ...
     * - minOccurs: 0
     * - nillable: true
     * @var \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\RequestToleranceData
     */
    public $Tolerance;
    /**
     * Constructor method for RequestLegData
     * @uses RequestLegData::setArrivalDate()
     * @uses RequestLegData::setArrivalSearchRadius()
     * @uses RequestLegData::setArrivalTime()
     * @uses RequestLegData::setArrivals()
     * @uses RequestLegData::setClass()
     * @uses RequestLegData::setDepartureDate()
     * @uses RequestLegData::setDepartureSearchRadius()
     * @uses RequestLegData::setDepartureTime()
     * @uses RequestLegData::setDepartures()
     * @uses RequestLegData::setTimeWindow()
     * @uses RequestLegData::setTolerance()
     ...
     * @param \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\RequestToleranceData $tolerance
     */
    public function __construct($arrivalDate = null, $arrivalSearchRadius = null, $arrivalTime = null, \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\ArrayType\ArrayOfstring $arrivals = null, $class = null, $departureDate = null, $departureSearchRadius = null, $departureTime = null, \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\ArrayType\ArrayOfstring $departures = null, $timeWindow = null, \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\RequestToleranceData $tolerance = null)
    {
        $this
     ...
     * @param string $arrivalDate
     * @return \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\RequestLegData
     */
     ...
     * this property may have been unset before, due to the fact that this property is
     * removable from the request (nillable=true+minOccurs=0)
     * @return \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\RequestToleranceData|null
     */
    public function getTolerance()
    {
        return isset($this->Tolerance) ? $this->Tolerance : null;
    }
    /**
     * Set Tolerance value
     * This property is removable from request (nillable=true+minOccurs=0), therefore
     ...
     * @return \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\RequestLegData
     */
    public function setTolerance(\Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\RequestToleranceData $tolerance = null)
    {
        if (is_null($tolerance) || (is_array($tolerance) && empty($tolerance))) {
