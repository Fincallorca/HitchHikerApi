...
/**
 * This class stands for BrowseResponseData StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:BrowseResponseData
 * @subpackage Structs
 */
class BrowseResponseData extends AbstractStructBase
{
    /**
     * The ModuleInfo
     * Meta informations extracted from the WSDL
     ...
     * - minOccurs: 0
     * - nillable: true
     * @var \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\ArrayType\ArrayOfBrowseResponseQueueItem
     */
    public $QueueItems;
    /**
     * The ResponseInfo
    ...
    public $Source;
    /**
     * Constructor method for BrowseResponseData
     * @uses BrowseResponseData::setModuleInfo()
     * @uses BrowseResponseData::setQueueItems()
     * @uses BrowseResponseData::setResponseInfo()
     * @uses BrowseResponseData::setSource()
     * @param \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\ModuleResponseData $moduleInfo
     * @param \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\ArrayType\ArrayOfBrowseResponseQueueItem $queueItems
     * @param \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\ResponseInfoDetails $responseInfo
     * @param string $source
     */
    public function __construct(\Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\ModuleResponseData $moduleInfo = null, \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\ArrayType\ArrayOfBrowseResponseQueueItem $queueItems = null, \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\ResponseInfoDetails $responseInfo = null, $source = null)
    {
        $this
     ...
     * @param \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\ModuleResponseData $moduleInfo
     * @return \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\BrowseResponseData
     */
    ...
    /**
     * Get QueueItems value
     * An additional test has been added (isset) before returning the property value as
     * this property may have been unset before, due to the fact that this property is
     * removable from the request (nillable=true+minOccurs=0)
     * @return \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\ArrayType\ArrayOfBrowseResponseQueueItem|null
     */
    public function getQueueItems()
    {
        return isset($this->QueueItems) ? $this->QueueItems : null;
    }
    /**
     ...
     * @return \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\BrowseResponseData
     */
    public function setQueueItems(\Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\ArrayType\ArrayOfBrowseResponseQueueItem $queueItems = null)
    {
        if (is_null($queueItems) || (is_array($queueItems) && empty($queueItems))) {
