...
/**
 * This class stands for QuoteRequestWebFareData StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:QuoteRequestWebFareData
 * @subpackage Structs
 */
class QuoteRequestWebFareData extends AbstractStructBase
{
    /**
     * The WebAgent
     * Meta informations extracted from the WSDL
    ...
    public $WebAgent;
    /**
     * Constructor method for QuoteRequestWebFareData
     * @uses QuoteRequestWebFareData::setWebAgent()
     * @param \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\Agent $webAgent
     */
    public function __construct(\Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\Agent $webAgent = null)
    {
        $this
     ...
     * @param \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\Agent $webAgent
     * @return \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\QuoteRequestWebFareData
     */
