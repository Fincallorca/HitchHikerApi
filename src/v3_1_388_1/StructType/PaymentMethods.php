...
class PaymentMethods extends AbstractStructBase
{
     ...
     * @uses PaymentMethods::setModuleInfo()
     * @uses PaymentMethods::setPaymentDetails()
     * @uses PaymentMethods::setResponseInfo()
     * @uses PaymentMethods::setSource()
     * @uses PaymentMethods::setTouroperatorCode()
     ...
     * @param \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\ModuleResponseData $moduleInfo
     * @return \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\PaymentMethods
     */
