...
/**
 * This class stands for CommonSegmentData StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:CommonSegmentData
 * @subpackage Structs
 */
class CommonSegmentData extends AbstractStructBase
{
    /**
     * The AllotmentConfig
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for CommonSegmentData
     * @uses CommonSegmentData::setAllotmentConfig()
     * @uses CommonSegmentData::setArrival()
     * @uses CommonSegmentData::setArrivalDateTime()
     * @uses CommonSegmentData::setBookingClass()
     * @uses CommonSegmentData::setCarrier()
     * @uses CommonSegmentData::setDeparture()
     * @uses CommonSegmentData::setDepartureDateTime()
     * @uses CommonSegmentData::setFlightNumber()
     * @uses CommonSegmentData::setSegmentStatus()
     ...
     * @param \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\AllotmentResponse $allotmentConfig
     * @return \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\CommonSegmentData
     */
