...
/**
 * This class stands for TaxesAndFeesCharter StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:TaxesAndFeesCharter
 * @subpackage Structs
 */
class TaxesAndFeesCharter extends AbstractStructBase
{
    /**
     * The Account
     * Meta informations extracted from the WSDL
    ...
    public $Touroperator;
    /**
     * Constructor method for TaxesAndFeesCharter
     * @uses TaxesAndFeesCharter::setAccount()
     * @uses TaxesAndFeesCharter::setTouroperator()
     ...
     * Set Account value
     * @param \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\CharterAccount $account
     * @return \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\TaxesAndFeesCharter
     */
