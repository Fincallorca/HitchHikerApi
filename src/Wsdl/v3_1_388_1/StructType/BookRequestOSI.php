...
/**
 * This class stands for BookRequestOSI StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:BookRequestOSI
 * @subpackage Structs
 */
class BookRequestOSI extends AbstractStructBase
{
    /**
     * The CarrierCode
     * Meta informations extracted from the WSDL
    ...
    public $FreeText;
    /**
     * Constructor method for BookRequestOSI
     * @uses BookRequestOSI::setCarrierCode()
     * @uses BookRequestOSI::setFreeText()
     ...
     * @param string $carrierCode
     * @return \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\BookRequestOSI
     */
