...
/**
 * This class stands for TermsAndConditionsResponseData StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:TermsAndConditionsResponseData
 * @subpackage Structs
 */
class TermsAndConditionsResponseData extends AbstractStructBase
{
    /**
     * The ModuleInfo
     * Meta informations extracted from the WSDL
    ...
    public $Text;
    /**
     * Constructor method for TermsAndConditionsResponseData
     * @uses TermsAndConditionsResponseData::setModuleInfo()
     * @uses TermsAndConditionsResponseData::setResponseInfo()
     * @uses TermsAndConditionsResponseData::setSource()
     * @uses TermsAndConditionsResponseData::setTermsAndConditionLinks()
     * @uses TermsAndConditionsResponseData::setText()
     ...
     * @param string $source
     * @param \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\ArrayType\ArrayOfstring $termsAndConditionLinks
     * @param string $text
     */
    public function __construct(\Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\ModuleResponseData $moduleInfo = null, \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\ResponseInfoDetails $responseInfo = null, $source = null, \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\ArrayType\ArrayOfstring $termsAndConditionLinks = null, $text = null)
    {
        $this
            ->setModuleInfo($moduleInfo)
            ->setResponseInfo($responseInfo)
            ->setSource($source)
            ->setTermsAndConditionLinks($termsAndConditionLinks)
            ->setText($text);
    }
    /**
     ...
     * @param \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\ModuleResponseData $moduleInfo
     * @return \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\TermsAndConditionsResponseData
     */
    ...
    /**
     * Get TermsAndConditionLinks value
     * An additional test has been added (isset) before returning the property value as
     * this property may have been unset before, due to the fact that this property is
     * removable from the request (nillable=true+minOccurs=0)
    ...
    {
        return isset($this->TermsAndConditionLinks) ? $this->TermsAndConditionLinks : null;
    }
    /**
     * Set TermsAndConditionLinks value
     * This property is removable from request (nillable=true+minOccurs=0), therefore
     * if the value assigned to this property is null, it is removed from this object
     * @param \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\ArrayType\ArrayOfstring $termsAndConditionLinks
     * @return \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\TermsAndConditionsResponseData
     */
    public function setTermsAndConditionLinks(\Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\ArrayType\ArrayOfstring $termsAndConditionLinks = null)
    {
        if (is_null($termsAndConditionLinks) || (is_array($termsAndConditionLinks) && empty($termsAndConditionLinks))) {
            unset($this->TermsAndConditionLinks);
        } else {
