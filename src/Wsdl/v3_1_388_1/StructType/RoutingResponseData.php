...
/**
 * This class stands for RoutingResponseData StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:RoutingResponseData
 * @subpackage Structs
 */
class RoutingResponseData extends AbstractStructBase
{
    /**
     * The ModuleInfo
     * Meta informations extracted from the WSDL
     ...
     * - minOccurs: 0
     * - nillable: true
     * @var \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\ArrayType\ArrayOfRoutingResponseInformation
     */
    ...
    public $Source;
    /**
     * Constructor method for RoutingResponseData
     * @uses RoutingResponseData::setModuleInfo()
     * @uses RoutingResponseData::setResponseInfo()
     * @uses RoutingResponseData::setRoutingInformation()
     * @uses RoutingResponseData::setSource()
     ...
     * @param \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\ArrayType\ArrayOfRoutingResponseInformation $routingInformation
     * @param string $source
     */
    public function __construct(\Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\ModuleResponseData $moduleInfo = null, \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\ResponseInfoDetails $responseInfo = null, \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\ArrayType\ArrayOfRoutingResponseInformation $routingInformation = null, $source = null)
    {
        $this
            ->setModuleInfo($moduleInfo)
            ->setResponseInfo($responseInfo)
            ->setRoutingInformation($routingInformation)
            ->setSource($source);
    }
    /**
     ...
     * @param \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\ModuleResponseData $moduleInfo
     * @return \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\RoutingResponseData
     */
    ...
    /**
     * Get RoutingInformation value
     * An additional test has been added (isset) before returning the property value as
     * this property may have been unset before, due to the fact that this property is
     * removable from the request (nillable=true+minOccurs=0)
     * @return \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\ArrayType\ArrayOfRoutingResponseInformation|null
     */
    public function getRoutingInformation()
    {
        return isset($this->RoutingInformation) ? $this->RoutingInformation : null;
    }
    /**
     * Set RoutingInformation value
     * This property is removable from request (nillable=true+minOccurs=0), therefore
     * if the value assigned to this property is null, it is removed from this object
     * @param \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\ArrayType\ArrayOfRoutingResponseInformation $routingInformation
     * @return \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\RoutingResponseData
     */
    public function setRoutingInformation(\Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\ArrayType\ArrayOfRoutingResponseInformation $routingInformation = null)
    {
        if (is_null($routingInformation) || (is_array($routingInformation) && empty($routingInformation))) {
            unset($this->RoutingInformation);
        } else {
