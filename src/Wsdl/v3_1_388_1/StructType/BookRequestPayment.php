...
/**
 * This class stands for BookRequestPayment StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:BookRequestPayment
 * @subpackage Structs
 */
class BookRequestPayment extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for BookRequestPayment
     * @uses BookRequestPayment::setBankAccountHolderFirstName()
     * @uses BookRequestPayment::setBankAccountHolderLastName()
     * @uses BookRequestPayment::setBankAccountNumber()
     * @uses BookRequestPayment::setBankAccountNumberIsCrypt()
     * @uses BookRequestPayment::setBankCodeNumber()
     * @uses BookRequestPayment::setBankName()
     * @uses BookRequestPayment::setCountryCode()
     * @uses BookRequestPayment::setCreditCardCVCNumber()
     * @uses BookRequestPayment::setCreditCardCVCNumberIsCrypt()
     * @uses BookRequestPayment::setCreditCardExpiryDate()
     * @uses BookRequestPayment::setCreditCardHolderFirstName()
     * @uses BookRequestPayment::setCreditCardHolderLastName()
     * @uses BookRequestPayment::setCreditCardNumber()
     * @uses BookRequestPayment::setCreditCardNumberIsCrypt()
     * @uses BookRequestPayment::setCreditCardPassword()
     * @uses BookRequestPayment::setCreditCardType()
     * @uses BookRequestPayment::setCreditCardUserName()
     * @uses BookRequestPayment::setFormOfPayment()
     * @uses BookRequestPayment::setPaymentType()
     * @uses BookRequestPayment::setWantApprovalCode()
     ...
     * @param string $bankAccountHolderFirstName
     * @return \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\BookRequestPayment
     */
