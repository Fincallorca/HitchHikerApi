...
/**
 * This class stands for FareRequestStay StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:FareRequestStay
 * @subpackage Structs
 */
class FareRequestStay extends AbstractStructBase
{
    /**
     * The CheckDaysAhead
     * @var int
    ...
    /**
     * Constructor method for FareRequestStay
     * @uses FareRequestStay::setCheckDaysAhead()
     * @uses FareRequestStay::setCheckDaysBack()
     ...
     * @param int $checkDaysAhead
     * @return \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\FareRequestStay
     */
