...
/**
 * This class stands for FareResponseETicket StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:FareResponseETicket
 * @subpackage Structs
 */
class FareResponseETicket extends AbstractStructBase
{
    /**
     * The ETicketAllowed
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for FareResponseETicket
     * @uses FareResponseETicket::setETicketAllowed()
     * @uses FareResponseETicket::setETicketBuyPrice()
     * @uses FareResponseETicket::setETicketSellPrice()
     ...
     * @param bool $eTicketAllowed
     * @return \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\FareResponseETicket
     */
