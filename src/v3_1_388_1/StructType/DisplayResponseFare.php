...
/**
 * This class stands for DisplayResponseFare StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:DisplayResponseFare
 * @subpackage Structs
 */
class DisplayResponseFare extends AbstractStructBase
{
    /**
     * The BoardingDetails
     * Meta informations extracted from the WSDL
     ...
     * - minOccurs: 0
     * - nillable: true
     * @var \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\DisplayResponseFlight
     */
    public $Flight;
    /**
     * The ID
    ...
    /**
     * Constructor method for DisplayResponseFare
     * @uses DisplayResponseFare::setBoardingDetails()
     * @uses DisplayResponseFare::setBookingCRS()
     * @uses DisplayResponseFare::setFlight()
     * @uses DisplayResponseFare::setID()
     * @uses DisplayResponseFare::setModificationInfo()
     * @uses DisplayResponseFare::setModuleInfo()
     * @uses DisplayResponseFare::setPaymentMethods()
     * @uses DisplayResponseFare::setPercentageDBCode()
     * @uses DisplayResponseFare::setPriceDetails()
     * @uses DisplayResponseFare::setSource()
     * @uses DisplayResponseFare::setUsedCRSProfile()
     ...
     * @param \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\DisplayResponseFlight $flight
     * @param string $iD
     ...
     * @param \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\ArrayType\ArrayOfBoardingResponseDetail $boardingDetails
     * @return \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\DisplayResponseFare
     */
     ...
     * this property may have been unset before, due to the fact that this property is
     * removable from the request (nillable=true+minOccurs=0)
     * @return \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\DisplayResponseFlight|null
     */
     ...
     * @return \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\DisplayResponseFare
     */
    public function setFlight(\Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\DisplayResponseFlight $flight = null)
    {
