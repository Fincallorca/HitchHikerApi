...
/**
 * This class stands for RequestPassengerData StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:RequestPassengerData
 * @subpackage Structs
 */
class RequestPassengerData extends AbstractStructBase
{
    /**
     * The DOB
     * Meta informations extracted from the WSDL
    ...
    public $Type;
    /**
     * Constructor method for RequestPassengerData
     * @uses RequestPassengerData::setDOB()
     * @uses RequestPassengerData::setForcePassengerType()
     * @uses RequestPassengerData::setNumber()
     * @uses RequestPassengerData::setType()
     * @param string $dOB
     ...
     * @param string $dOB
     * @return \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\RequestPassengerData
     */
