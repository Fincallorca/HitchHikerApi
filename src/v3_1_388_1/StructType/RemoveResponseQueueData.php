...
/**
 * This class stands for RemoveResponseQueueData StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:RemoveResponseQueueData
 * @subpackage Structs
 */
class RemoveResponseQueueData extends RemoveQueueData
{
    ...
    public $ErrorCode;
    /**
     * Constructor method for RemoveResponseQueueData
     * @uses RemoveResponseQueueData::setErrorCode()
     ...
     * @param string $errorCode
     * @return \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\RemoveResponseQueueData
     */
