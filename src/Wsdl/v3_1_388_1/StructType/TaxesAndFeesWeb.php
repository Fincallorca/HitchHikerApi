...
/**
 * This class stands for TaxesAndFeesWeb StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:TaxesAndFeesWeb
 * @subpackage Structs
 */
class TaxesAndFeesWeb extends AbstractStructBase
{
    /**
     * The CountryCode
     * Meta informations extracted from the WSDL
    ...
    public $WebAgent;
    /**
     * Constructor method for TaxesAndFeesWeb
     * @uses TaxesAndFeesWeb::setCountryCode()
     * @uses TaxesAndFeesWeb::setWebAgent()
     ...
     * @param string $countryCode
     * @return \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\TaxesAndFeesWeb
     */
