...
/**
 * This class stands for ResponseTicket StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:ResponseTicket
 * @subpackage Structs
 */
class ResponseTicket extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for ResponseTicket
     * @uses ResponseTicket::setLastTicketingDate()
     * @uses ResponseTicket::setMaxTicketingAfterBook()
     * @uses ResponseTicket::setMinTicketingBeforeDep()
     * @uses ResponseTicket::setTicketOnDepInfo()
     ...
     * @param string $lastTicketingDate
     * @return \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\ResponseTicket
     */
