...
/**
 * This class stands for FareResponsePTicket StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:FareResponsePTicket
 * @subpackage Structs
 */
class FareResponsePTicket extends AbstractStructBase
{
    /**
     * The PTicketAllowed
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for FareResponsePTicket
     * @uses FareResponsePTicket::setPTicketAllowed()
     * @uses FareResponsePTicket::setPTicketBuyPrice()
     * @uses FareResponsePTicket::setPTicketSellPrice()
     ...
     * @param bool $pTicketAllowed
     * @return \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\FareResponsePTicket
     */
