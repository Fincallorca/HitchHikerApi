...
/**
 * This class stands for DisplayResponsePassenger StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:DisplayResponsePassenger
 * @subpackage Structs
 */
class DisplayResponsePassenger extends AbstractStructBase
{
    /**
     * The AgencyBuy
     * Meta informations extracted from the WSDL
     ...
     * - minOccurs: 0
     * - nillable: true
     * @var \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\DisplayResponseETicket
     */
     ...
     * - minOccurs: 0
     * - nillable: true
     * @var \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\DisplayResponsePTicket
     */
    public $PaperTicket;
    /**
     * The PassengerType
    ...
    public $TotalTax;
    /**
     * Constructor method for DisplayResponsePassenger
     * @uses DisplayResponsePassenger::setAgencyBuy()
     * @uses DisplayResponsePassenger::setAgencySell()
     * @uses DisplayResponsePassenger::setAirlineSell()
     * @uses DisplayResponsePassenger::setBrokerBuy()
     * @uses DisplayResponsePassenger::setBrokerSell()
     * @uses DisplayResponsePassenger::setCalcType()
     * @uses DisplayResponsePassenger::setCalculationGroup()
     * @uses DisplayResponsePassenger::setCalculationRule()
     * @uses DisplayResponsePassenger::setElectronicTicket()
     * @uses DisplayResponsePassenger::setEndconsumerBuy()
     * @uses DisplayResponsePassenger::setEquivalentAgencyBuy()
     * @uses DisplayResponsePassenger::setEquivalentAgencySell()
     * @uses DisplayResponsePassenger::setEquivalentAirlineSell()
     * @uses DisplayResponsePassenger::setEquivalentBrokerBuy()
     * @uses DisplayResponsePassenger::setEquivalentBrokerSell()
     * @uses DisplayResponsePassenger::setEquivalentEndconsumerBuy()
     * @uses DisplayResponsePassenger::setEquivalentQSurcharge()
     * @uses DisplayResponsePassenger::setEquivalentServiceFee()
     * @uses DisplayResponsePassenger::setEquivalentTotalTax()
     * @uses DisplayResponsePassenger::setFareSubType()
     * @uses DisplayResponsePassenger::setFareType()
     * @uses DisplayResponsePassenger::setFareTypeDetails()
     * @uses DisplayResponsePassenger::setHasServiceFee()
     * @uses DisplayResponsePassenger::setPaperTicket()
     * @uses DisplayResponsePassenger::setPassengerType()
     * @uses DisplayResponsePassenger::setPassengerTypeName()
     * @uses DisplayResponsePassenger::setQSurcharge()
     * @uses DisplayResponsePassenger::setServiceFee()
     * @uses DisplayResponsePassenger::setTotalTax()
     ...
     * @param \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\DisplayResponseETicket $electronicTicket
     ...
     * @param \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\DisplayResponsePTicket $paperTicket
     ...
     * @param \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\SharedPrice $agencyBuy
     * @return \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\DisplayResponsePassenger
     */
     ...
     * this property may have been unset before, due to the fact that this property is
     * removable from the request (nillable=true+minOccurs=0)
     * @return \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\DisplayResponseETicket|null
     */
     ...
     * @return \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\DisplayResponsePassenger
     */
    public function setElectronicTicket(\Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\DisplayResponseETicket $electronicTicket = null)
    {
     ...
     * this property may have been unset before, due to the fact that this property is
     * removable from the request (nillable=true+minOccurs=0)
     * @return \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\DisplayResponsePTicket|null
     */
     ...
     * @return \Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\DisplayResponsePassenger
     */
    public function setPaperTicket(\Fincallorca\HitchHikerApi\Wsdl\v3_1_388_1\StructType\DisplayResponsePTicket $paperTicket = null)
    {
